...
#define KEYPAD_UP        SDLK_KP8
#define KEYPAD_DOWN      SDLK_KP2
#define KEYPAD_LEFT      SDLK_KP4
#define KEYPAD_RIGHT     SDLK_KP6
#define KEYPAD_OK        SDLK_KP1
#define KEYPAD_CANCEL    SDLK_KP3
...
void io_init(void){
	...
	CURSORS[5]=makeCursor((pair){8,9},image_read(lmistr("%%IMG3ABAAEgZAgFAIKhqHSGJgyQQlhyBm86mUBpzUqBWbjBqN1+4VTEZ6ycUwdJwGqwHnZvp9/rbNbPtbafdmrXt4W1RwgFxig4R9SUE=")));
	CURSORS[6]=makeCursor((pair){8,8},image_read(lmistr("%%IMG3ABAAEAZAgFAIKhqHSEAxwGwWk6Cm1DmMTq8gotRoZWa7VOW2S9Z6yWU0VX0Ok53grHj6HS/dV2w1H66Cz0l+XElB")));
	CURSORS[7]=makeCursor((pair){5,5},image_read(lmistr("%%IMG0ABAACwQABAAEAAQABAD74AQABAAEAAQABAA=")));
	if(!nosound){
		audio.freq=SFX_RATE;
