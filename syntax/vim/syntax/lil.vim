...
syn keyword   lilPrims   floor cos sin tan exp ln sqrt count sum prod min max raze first last range keys list table rows cols mag unit heading trim ceil rev
