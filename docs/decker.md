...
With any of the drawing tools selected, you can press `m` to toggle the visibility of Decker's main menu. Holding control or command while clicking will enter Fat Bits mode centered on the position you click. Right-clicking with any tool will _erase_: this behaves like the pencil tool, but always draws using pattern 0.
